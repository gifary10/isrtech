import { getCategoryTitles, getFeatureNamesByCategory, pricingCategories } from './core.js';

// Expose pricingCategories to window for fallback access
window.pricingCategories = pricingCategories;
